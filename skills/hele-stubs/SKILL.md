...
On `1`: immediately read `${CLAUDE_PLUGIN_ROOT}/skills/hele-build/SKILL.md` and execute it in this same turn. Do not wait for a second prompt; do not ask the CEO to type `/hele-build`.
</phase>
